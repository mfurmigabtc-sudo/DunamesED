    ...
    <footer className="bg-slate-950 text-white py-12 border-t border-slate-900">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center gap-2 font-bold text-2xl mb-2">
              ...
              <span>Dunames<span className="text-amber-500">Edificações</span></span>
            </div>
        ...
        <div className="mt-10 pt-6 border-t border-slate-900 text-center text-slate-600 text-sm">
          <p>&copy; {new Date().getFullYear()} Dunames Edificações - Marco Dunames. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
