  ...
  return (
    <section id="quem-sou" className="py-24 bg-gradient-to-r from-slate-300 to-slate-400 relative overflow-hidden scroll-mt-28">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-center relative z-10">
        ...
        {/* Left Column: Image */}
        {/* Note for User: Replace the src below with the actual photo of Marco Dunames removed from background or on a transparent background for best effect, 
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end mb-10 md:mb-0 md:pr-12">
          <img 
            src="/imgquemsoueu.jpeg" 
            alt="Marco Dunames" 
            className="w-full max-w-sm md:max-w-md h-auto object-cover shadow-2xl rounded-2xl border-4 border-white/40"
          />
        </div>
